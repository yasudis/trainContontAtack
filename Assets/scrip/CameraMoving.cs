...
public class CameraMoving : MonoBehaviour
{
    ...
    private void Update()
    {
        cameraPositionPlayer = new Vector3(player.transform.position.x, player.transform.position.y + 24, player.transform.position.z - 20);
        transform.position = Vector3.MoveTowards(transform.position, cameraPositionPlayer, moveSpeed * Time.deltaTime);
